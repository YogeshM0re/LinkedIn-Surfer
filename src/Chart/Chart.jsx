  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">
        {`${currentChartIndex === 0 ? "Designation" : "Location"} Chart`}
      </h2>
      <button
        className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-full focus:outline-none focus:ring focus:border-blue-300"
        onClick={() =>
